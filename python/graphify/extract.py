...
from python.graphify.extractors.base import (  # noqa: F401
    _LANGUAGE_BUILTIN_GLOBALS,
    _file_stem,
    _make_id,
    _read_text,
)
from python.graphify.extractors.blade import extract_blade  # noqa: F401
from python.graphify.extractors.csharp import (
    _resolve_cross_file_csharp_imports,
    _resolve_csharp_type_references,
)
from python.graphify.extractors.elixir import extract_elixir  # noqa: F401
from python.graphify.extractors.razor import extract_razor  # noqa: F401
from python.graphify.extractors.zig import extract_zig  # noqa: F401
from python.graphify.security import sanitize_metadata
from python.graphify.paths import disambiguate_ambiguous_candidates
...
def extract_bash(path: Path) -> dict:
    ...
    from python.graphify.security import sanitize_metadata  # module-level cached import
