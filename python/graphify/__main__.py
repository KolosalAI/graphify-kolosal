...
def uninstall_all(project_dir: Path | None = None, purge: bool = False) -> None:
    ...
    # Git hook
    try:
        from python.graphify.hooks import uninstall as hook_uninstall
...
def main() -> None:
    ...
    if cmd == "install":
        ...
        from python.graphify.llm import _custom_providers_path, BACKENDS
        ...
        if subcmd == "list":
            ...
            if not base_url or not default_model or not env_key:
                ...
                sys.exit(1)
            from python.graphify.llm import provider_base_url_ok
        ...
        from python.graphify.prs import cmd_prs
        cmd_prs(sys.argv[2:])
    elif cmd == "hook":
        from python.graphify.hooks import (
        ...
        if len(sys.argv) < 3:
            ...
            sys.exit(1)
        from python.graphify.affected import DEFAULT_AFFECTED_RELATIONS, format_affected, load_graph
        query = sys.argv[2]
        graph_path = _default_graph_path()
        depth = 2
        relations: list[str] = []
        ...
        from python.graphify.ingest import save_query_result as _sqr
        ...
        opts = p.parse_args(sys.argv[2:])
        from python.graphify.reflect import reflect as _reflect, lessons_fresh as _lessons_fresh
        ...
        if len(sys.argv) < 4:
            ...
            sys.exit(1)
        from python.graphify.serve import _score_nodes
        from networkx.readwrite import json_graph
        import networkx as _nx
        ...
        if len(sys.argv) < 3:
            ...
            sys.exit(1)
        from python.graphify.serve import _find_node
        from networkx.readwrite import json_graph
        ...
        try:
            ...
            from python.graphify.security import sanitize_label as _sl
            _overlay = _llo(gp)
        ...
        if len(sys.argv) < 3:
            ...
            sys.exit(1)
        from python.graphify.ingest import ingest as _ingest
        ...
        if not watch_path.exists():
            ...
            sys.exit(1)
        from python.graphify.watch import watch as _watch
        ...
        from python.graphify.cluster import cluster, score_all, remap_communities_to_previous
        from python.graphify.analyze import (
            god_nodes,
        ...
        from python.graphify.security import check_graph_file_size_cap as _check_cap
        _over_cap = False
        try:
        ...
        if labels_path.exists() and not force_relabel:
            ...
            from python.graphify.cluster import community_member_sigs, label_communities_by_hub
            ...
            from python.graphify.llm import generate_community_labels
        ...
        from python.graphify.export import _git_head as _gh
        _commit = _gh()
        ...
        from python.graphify.cluster import community_member_sigs as _cms
        ...
        from python.graphify.tree_html import write_tree_html, DEFAULT_MAX_CHILDREN
        ...
        import networkx as _nx
        from networkx.readwrite import json_graph as _jg
        from python.graphify.build import prefix_graph_for_global as _prefix
        graphs = []
        ...
        if subcmd == "callflow-html":
            from python.graphify.callflow_html import write_callflow_html as _write_callflow_html
        ...
        from networkx.readwrite import json_graph as _jg
        from python.graphify.build import build_from_json as _bfj
        from python.graphify.security import check_graph_file_size_cap as _check_cap
        ...
        if subcmd == "html":
            from python.graphify.export import to_html as _to_html
            if no_viz:
            ...
            from python.graphify.export import to_obsidian as _to_obsidian, to_canvas as _to_canvas
            ...
            from python.graphify.wiki import to_wiki as _to_wiki
            ...
            if push_uri:
                ...
                from python.graphify.export import to_cypher as _to_cypher
            ...
            if push_uri:
                from python.graphify.export import push_to_falkordb as _push
                result = _push(G, uri=push_uri, user=push_user,
                               password=push_password, communities=communities)
        ...
        from python.graphify.benchmark import run_benchmark, print_benchmark
        ...
        subcmd = sys.argv[2] if len(sys.argv) > 2 else ""
        from python.graphify.global_graph import (
        ...
        from python.graphify.llm import (
        ...
        if needs_llm:
            if backend is None:
                ...
                sys.exit(1)
            if backend == "ollama":
                from python.graphify.llm import _validate_ollama_base_url
        ...
        if code_files:
            from python.graphify.extract import extract as _ast_extract
        ...
        from python.graphify.cache import (
        ...
        try:
            from python.graphify.cache import file_hash as _file_hash
        ...
        if no_cluster:
            ...
            try:
                ...
                print(f"[graphify extract] warning: could not write manifest: {exc}", file=sys.stderr)
            if global_merge:
                from python.graphify.global_graph import global_add as _global_add
        ...
        from python.graphify.build import (
            build as _build,
            build_from_json as _build_from_json,
            build_merge as _build_merge,
        )
        from python.graphify.cluster import cluster as _cluster, score_all as _score_all
        from python.graphify.export import to_json as _to_json
        from python.graphify.analyze import god_nodes as _god_nodes, surprising_connections as _surprising
        ...
        from python.graphify.cache import check_semantic_cache
        if len(sys.argv) < 3:
