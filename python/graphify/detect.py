...
from python.graphify.google_workspace import (
    GOOGLE_WORKSPACE_EXTENSIONS,
    convert_google_workspace_file,
    google_workspace_enabled,
)
from python.graphify.paths import GRAPHIFY_OUT, GRAPHIFY_OUT_NAME, out_path
...
def classify_file(path: Path) -> FileType | None:
    ...
    from python.graphify.manifest_ingest import is_package_manifest_path
