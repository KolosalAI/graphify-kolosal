...
from python.graphify.extractors.blade import extract_blade
from python.graphify.extractors.elixir import extract_elixir
from python.graphify.extractors.razor import extract_razor
from python.graphify.extractors.zig import extract_zig
