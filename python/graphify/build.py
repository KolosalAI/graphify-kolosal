...
def _semantic_id_remap(nodes: list, root: str | None) -> dict:
    ...
    from python.graphify.extractors.base import _file_stem  # local: avoid import cost at module load
...
def build_from_json(extraction: dict, *, directed: bool = False, root: str | Path | None = None) -> nx.Graph:
    ...
    from python.graphify.extractors.base import _file_stem as _fs
    for nid in node_set:
        attrs = G.nodes[nid]
    ...
    *,
    ...
    if existing_hyperedges:
        ...
        for he in existing_hyperedges:
            ...
            carried.append(he)
        if carried:
            from python.graphify.export import attach_hyperedges
