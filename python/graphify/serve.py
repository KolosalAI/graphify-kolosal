...
from python.graphify.security import sanitize_label, check_graph_file_size_cap
from python.graphify.build import edge_data
from python.graphify.paths import default_graph_json as _default_graph_json
...
def _load_graph(graph_path: str) -> nx.Graph:
    try:
        ...
        try:
            from python.graphify.build import graph_has_legacy_ids as _legacy
        ...
        try:
            from python.graphify.reflect import load_learning_overlay as _llo
...
def _build_server(graph_path: str):
    ...
    def _tool_query_graph(arguments: dict) -> str:
        ...
        from python.graphify import querylog
    ...
    def _tool_god_nodes(arguments: dict) -> str:
        from python.graphify.analyze import god_nodes as _god_nodes
    ...
    def _tool_list_prs(arguments: dict) -> str:
        from python.graphify.prs import fetch_prs, fetch_worktrees, format_prs_text, _detect_default_branch
    ...
    def _tool_get_pr_impact(arguments: dict) -> str:
        from python.graphify.prs import fetch_pr_files, compute_pr_impact, _gh, _parse_ci
    ...
    def _tool_triage_prs(arguments: dict) -> str:
        ...
        from python.graphify.prs import fetch_prs, fetch_worktrees, fetch_pr_files, compute_pr_impact, _STATUS_ORDER, _detect_default_branch
        repo = arguments.get("repo") or None
        base = arguments.get("base") or _detect_default_branch(repo)
        try:
            prs = fetch_prs(repo=repo, base=base)
    ...
    async def read_resource(uri: AnyUrl) -> str:
        ...
        if uri_str == "graphify://surprises":
            try:
                from python.graphify.analyze import surprising_connections
        ...
        if uri_str == "graphify://questions":
            try:
                from python.graphify.analyze import suggest_questions
