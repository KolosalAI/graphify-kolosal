...
import pytest
from python.graphify.extract import (
...
def test_metal_is_code_extension():
    from python.graphify.detect import CODE_EXTENSIONS
...
def test_swift_imports_survive_build():
    ...
    from python.graphify.build import build_from_json
    r = extract_swift(FIXTURES / "sample.swift")
    import_edges = [e for e in r["edges"] if e["relation"] == "imports"]
...
def test_swift_extension_across_files_merges_into_canonical_type():
    ...
    from python.graphify.extract import extract
...
from python.graphify.extract import extract_elixir
...
# ── Objective-C ──────────────────────────────────────────────────────────────
from python.graphify.extract import extract_objc
...
def test_objc_header_dispatch_routes_objc_not_c(tmp_path):
    ...
    from python.graphify.extract import _get_extractor, extract_objc as _eo, extract_c as _ec
...
from python.graphify.extract import extract_markdown
