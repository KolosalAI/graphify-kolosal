...
def no_tokenizer():
    ...
    from python.graphify import llm
...
def test_pack_chunks_packs_small_files_together(tmp_path):
    ...
    from python.graphify.llm import _pack_chunks_by_tokens
...
def test_corpus_parallel_runs_chunks_concurrently(tmp_path):
    ...
    from python.graphify.llm import extract_corpus_parallel
...
def test_adaptive_retry_returns_directly_when_not_truncated(tmp_path):
    ...
    from python.graphify.llm import _extract_with_adaptive_retry
