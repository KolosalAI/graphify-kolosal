...
from python.graphify.cache import file_hash, cache_dir, load_cached, save_cached, cached_files, clear_cache, _body_content
...
def test_save_cached_relativizes_source_file(tmp_path):
    ...
    import json
    from python.graphify.cache import save_cached, file_hash, cache_dir
...
def test_load_cached_absolutizes_source_file(tmp_path):
    ...
    from python.graphify.cache import save_cached, load_cached
...
def test_load_cached_passes_through_legacy_absolute_source_file(tmp_path):
    ...
    import json
    from python.graphify.cache import load_cached, file_hash, cache_dir
...
def test_cache_portable_across_roots(tmp_path):
    ...
    import json
    import shutil
    from python.graphify.cache import save_cached, load_cached, file_hash, cache_dir
...
def test_ast_cache_invalidated_on_version_bump(tmp_path, monkeypatch):
    ...
    import python.graphify.cache as cache_mod
...
def test_legacy_unversioned_ast_entries_not_served(tmp_path):
    ...
    import json
    from python.graphify.cache import file_hash, _GRAPHIFY_OUT
...
def test_semantic_prune_removes_orphan_entries(tmp_path):
    ...
    current one."""
    from python.graphify.cache import prune_semantic_cache
