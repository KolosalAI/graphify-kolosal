...
from python.graphify.build import build_from_json, build, build_merge, edge_data, edge_datas, dedupe_edges, dedupe_nodes
...
def test_graph_has_legacy_ids_detects_old_scheme():
    ...
    from python.graphify.build import graph_has_legacy_ids
...
def test_semantic_rekey_relative_vs_absolute_source_file():
    ...
    from python.graphify.build import _semantic_id_remap
