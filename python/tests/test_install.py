...
def _install(tmp_path, platform):
    from python.graphify.__main__ import install
...
def test_install_positional_platform_opencode(tmp_path, monkeypatch):
    from python.graphify.__main__ import main
...
def test_codex_skill_contains_spawn_agent():
    ...
    import python.graphify as graphify
...
def test_codebuddy_install_writes_codebuddy_md(tmp_path):
    from python.graphify.__main__ import codebuddy_install
...
def test_codebuddy_uninstall_removes_section(tmp_path):
    from python.graphify.__main__ import codebuddy_install, codebuddy_uninstall
    codebuddy_install(tmp_path)
...
def test_codebuddy_uninstall_noop_if_not_installed(tmp_path):
    from python.graphify.__main__ import codebuddy_uninstall
...
def _agents_install(tmp_path, platform):
    from python.graphify.__main__ import _agents_install as _install_fn

    _install_fn(tmp_path, platform)


def _agents_uninstall(tmp_path, platform=""):
    from python.graphify.__main__ import _agents_uninstall as _uninstall_fn

    _uninstall_fn(tmp_path, platform=platform)


def _kilo_install(project_dir, home_dir):
    from python.graphify.__main__ import _kilo_install as _install_fn
...
def _kilo_uninstall(project_dir, home_dir):
    from python.graphify.__main__ import _kilo_uninstall as _uninstall_fn
...
def test_cursor_install_writes_rule(tmp_path):
    ...
    from python.graphify.__main__ import _cursor_install
...
def test_cursor_uninstall_removes_rule(tmp_path):
    ...
    from python.graphify.__main__ import _cursor_install, _cursor_uninstall
...
def test_cursor_uninstall_noop_if_not_installed(tmp_path):
    ...
    from python.graphify.__main__ import _cursor_uninstall
...
def test_gemini_install_writes_gemini_md(tmp_path):
    from python.graphify.__main__ import gemini_install
...
def test_gemini_uninstall_removes_section(tmp_path):
    from python.graphify.__main__ import gemini_install, gemini_uninstall
...
def test_gemini_uninstall_noop_if_not_installed(tmp_path):
    from python.graphify.__main__ import gemini_uninstall
...
def test_hermes_skill_destination_windows_uses_localappdata():
    ...
    from python.graphify.__main__ import _platform_skill_destination
