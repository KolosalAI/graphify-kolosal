...
def test_pascal_no_error():
    from python.graphify.extract import extract_pascal
...
def test_lfm_no_error():
    from python.graphify.extract import extract_lazarus_form
...
def test_lpk_no_error():
    from python.graphify.extract import extract_lazarus_package
...
def test_dfm_no_error():
    from python.graphify.extract import extract_delphi_form
