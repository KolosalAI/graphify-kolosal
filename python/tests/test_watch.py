...
from python.graphify.watch import _notify_only, _WATCHED_EXTENSIONS, _rebuild_lock, _check_shrink
...
def test_check_update_no_flag_returns_true(tmp_path):
    ...
    from python.graphify.watch import check_update
...
def test_watch_raises_without_watchdog(tmp_path, monkeypatch):
    ...
    from python.graphify.watch import watch
...
def test_graphify_root_preserves_relative_when_invoked_with_relative_path(tmp_path, monkeypatch):
    ...
    from python.graphify.watch import _rebuild_code
...
def test_rebuild_code_is_idempotent_when_cluster_ids_flap(tmp_path, monkeypatch):
    from python.graphify import cluster as cluster_mod
    from python.graphify.watch import _rebuild_code
...
def test_watch_handler_honors_graphifyignore(tmp_path, monkeypatch):
    ...
    """
    import threading
    from python.graphify import watch as watch_mod
...
def test_watch_loads_graphifyignore_once(tmp_path, monkeypatch):
    ...
    import threading
    from python.graphify import watch as watch_mod
    from python.graphify import detect as detect_mod
...
def test_queue_and_drain_pending_round_trip(tmp_path):
    ...
    from python.graphify.watch import _queue_pending, _drain_pending, _PENDING_FILENAME
...
def test_drain_pending_dedupes_and_skips_blank_lines(tmp_path):
    ...
    from python.graphify.watch import _queue_pending, _drain_pending
...
def test_queue_pending_noop_on_empty_list(tmp_path):
    ...
    from python.graphify.watch import _queue_pending, _PENDING_FILENAME
...
def test_rebuild_code_queues_on_lock_contention(tmp_path, monkeypatch, capsys):
    ...
    from python.graphify.watch import _rebuild_code, _rebuild_lock, _PENDING_FILENAME
...
def test_rebuild_code_drains_late_arrivals(tmp_path, monkeypatch):
    ...
    from python.graphify import watch as watch_mod
    from python.graphify.watch import _rebuild_code as orig_rebuild
...
def test_merge_changed_paths_dedupes_in_order():
    ...
    from python.graphify.watch import _merge_changed_paths
