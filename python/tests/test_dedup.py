...
import pytest
from python.graphify.dedup import deduplicate_entities, _entropy, _shingles
...
def test_build_calls_dedup():
    ...
    from python.graphify.build import build
    chunk1 = {
...
def test_dedup_still_merges_real_typos():
    ...
    from python.graphify.dedup import _is_variant_pair, _short_label_blocked
...
def test_variant_pair_helper():
    ...
    from python.graphify.dedup import _is_variant_pair
...
def test_prefix_guard_does_not_block_same_length_typos():
    ...
    from python.graphify.dedup import _norm
...
def test_numeric_tokens_differ_helper():
    ...
    multisets (#1284)."""
    from python.graphify.dedup import _numeric_tokens_differ
