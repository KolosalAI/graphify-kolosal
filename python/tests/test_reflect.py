...
from python.graphify.ingest import save_query_result
from python.graphify.reflect import (
    aggregate_lessons,
    lessons_fresh,
    load_memory_docs,
    parse_memory_doc,
...
def _make_graph(tmp_path: Path) -> Path:
    ...
    from python.graphify.analyze import god_nodes, surprising_connections
    from python.graphify.export import to_json
...
from python.graphify.reflect import (  # noqa: E402
