...
from python.graphify.build import _normalize_id
from python.graphify.extract import _make_id
from python.graphify.ids import make_id, normalize_id
...
def test_both_callers_share_one_implementation():
    ...
    from python.graphify.mcp_ingest import _make_id as _mcp_make_id
    from python.graphify.symbol_resolution import _bash_make_id
