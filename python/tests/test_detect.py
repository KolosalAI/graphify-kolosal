...
from python.graphify.detect import classify_file, count_words, detect, detect_incremental, save_manifest, FileType, _looks_like_paper, _is_ignored, _load_graphifyignore, _is_sensitive
...
def test_classify_video_extensions():
    ...
    from python.graphify.detect import FileType
...
def test_negation_cannot_rescue_file_under_excluded_dir(tmp_path):
    ...
    from python.graphify.detect import _is_ignored, _load_graphifyignore
...
def test_negation_does_not_disable_directory_pruning(tmp_path, monkeypatch):
    ...
    """
    import os
    import python.graphify.detect as det
...
def test_is_ignored_cache_evaluates_each_dir_once():
    ...
    """
    from python.graphify.detect import _is_ignored
...
def test_save_manifest_skips_semantic_hash_for_files_without_cache(tmp_path):
    ...
    import json
    from python.graphify.cache import save_cached
...
def test_shebang_interpreter_plain(tmp_path):
    ...
    from python.graphify.detect import _shebang_interpreter
...
def test_save_manifest_relativizes_keys_when_root_given(tmp_path):
    ...
    import json
    from python.graphify.detect import save_manifest, load_manifest
...
def test_load_manifest_absolutizes_relative_keys(tmp_path):
    ...
    import json
    from python.graphify.detect import load_manifest
...
def test_detect_incremental_portable_across_paths(tmp_path):
    ...
    import json
    from python.graphify.detect import save_manifest, detect_incremental
