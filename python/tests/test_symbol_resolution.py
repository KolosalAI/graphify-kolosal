...
from python.graphify.symbol_resolution import (
    _bash_make_id,
    build_label_index,
...
def test_bash_make_id_identical_to_make_id() -> None:
    from python.graphify.extract import _make_id
...
def test_parse_python_import_aliases_skips_function_local_imports(tmp_path):
    ...
    from python.graphify.symbol_resolution import parse_python_import_aliases
...
def test_node_is_resolvable_symbol_requires_code_file_type():
    ...
    from python.graphify.symbol_resolution import node_is_resolvable_symbol
...
def test_build_label_index_excludes_non_code_nodes():
    ...
    from python.graphify.symbol_resolution import build_label_index
...
def test_resolve_bash_source_edges_skips_malformed_source(tmp_path):
    ...
    from python.graphify.symbol_resolution import resolve_bash_source_edges
...
def test_iter_raw_calls_skips_non_dict_per_file_entries():
    ...
    from python.graphify.symbol_resolution import iter_raw_calls
...
def test_resolve_cross_file_raw_calls_survives_malformed_raw_calls():
    ...
    from python.graphify.symbol_resolution import resolve_cross_file_raw_calls
...
def test_resolve_python_import_guided_calls_survives_malformed_raw_calls(tmp_path):
    ...
    from python.graphify.symbol_resolution import resolve_python_import_guided_calls
...
def test_resolve_python_import_guided_calls_metadata_sanitizes_hostile_alias(
    ...
    """
    import python.graphify.symbol_resolution as sr
